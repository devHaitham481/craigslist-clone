...
Category.create!([
    ...
    { name: "discussion forms", url: "discussions" },
    ...
    { name: "local news", url: "local", parent_id: 1 },
    { name: "lost+found", url: "lost", parent_id: 1 },
    { name: "missed connection", url: "missed", parent_id: 1 },
    { name: "musicians", url: "musicians", parent_id: 1 },
    { name: "pets", url: "pets", parent_id: 1 },
    { name: "politics", url: "politics", parent_id: 1 },
    { name: "rants & raves", url: "rants", parent_id: 1 },
    ...
    { name: "cell/mobile", url: "cell", parent_id: 2 },
    { name: "computer", url: "computer", parent_id: 2 },
    { name: "creative", url: "creative", parent_id: 2 },
    { name: "cycle", url: "cycle", parent_id: 2 },
    { name: "events", url: "events", parent_id: 2 },
    { name: "farm+garden", url: "farm", parent_id: 2 },
    ...
    { name: "pet", url: "pets", parent_id: 2 },
    { name: "real estate", url: "estate", parent_id: 2 },
    { name: "skilled trade", url: "skilled", parent_id: 2 },
    { name: "sm biz ads", url: "biz", parent_id: 2 },
    { name: "travel/vac", url: "travel", parent_id: 2 },
    { name: "write/ed/tran", url: "write", parent_id: 2 },
    ])
    ...
    Category.create!([
    { name: "apts/housing", url: "apt-housing", parent_id: 4 },
    ...
    { name: "rooms/shared", url: "shared-rooms", parent_id: 4 },
    { name: "rooms wanted", url: "rooms-wanted", parent_id: 4 },
    { name: "sublets / temporary", url: "sublets", parent_id: 4 },
    ...
    { name: "appliances", url: "applications", parent_id: 5 },
    { name: "arts+crafts", url: "arts-crafts", parent_id: 5 },
    { name: "atv/utv/sno", url: "atv", parent_id: 5 },
    ...
    { name: "beauty+health", url: "beauty-health", parent_id: 5 },
    ...
    { name: "cds/dvd/vhs", url: "cds", parent_id: 5 },
    { name: "cell phones", url: "cell-phones", parent_id: 5 },
    { name: "clothes+acc", url: "clothes", parent_id: 5 },
    ...
    { name: "furniture", url: "furtniture", parent_id: 5 },
    ...
    { name: "wheel+tires", url: "wheels-tires", parent_id: 5 },
    ])


    Category.create!([
    { name: "accounting+finance", url: "accounting-finance", parent_id: 6 },
    { name: "admin", url: "admin", parent_id: 6 },
    { name: "arch/engineering", url: "arch-engineering", parent_id: 6 },
    { name: "arts/media/design", url: "arts", parent_id: 6 },
    ...
    { name: "marketing/pr/ad", url: "marketing", parent_id: 6 },
    { name: "medical/health", url: "medical-health", parent_id: 6 },
    { name: "nonprofit sector", url: "non-profit", parent_id: 6 },
    { name: "real estate", url: "real-estate", parent_id: 6 },
    { name: "retail/wholesale", url: "retail-wholesale", parent_id: 6 },
    { name: "sales/biz dev", url: "sales-biz", parent_id: 6 },
    { name: "salon/spa/fitness", url: "salon-spa", parent_id: 6 },
    { name: "security", url: "security", parent_id: 6 },
    { name: "skilled trade/craft", url: "skilled-trade", parent_id: 6 },
    { name: "software/qa/dba", url: "software", parent_id: 6 },
    ...
    { name: "tv/film/video", url: "tv-film", parent_id: 6 },
    { name: "web/info design", url: "web-info", parent_id: 6 },
